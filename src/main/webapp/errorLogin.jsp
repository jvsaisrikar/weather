	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-5 form-section">
			<div class="login-wrapper">
				<h2 class="login-title">Login Unsuccessful!</h2>
				<p class="login-wrapper-footer-text">Email/Password is incorrect.</p>
				
				<p class="login-wrapper-footer-text">
					Try Again? <a href="index.jsp" class="text-reset">Login here</a>
				</p>
			</div>
		</div>
	</div>
